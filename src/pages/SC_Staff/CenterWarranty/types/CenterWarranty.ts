...
//Tương ứng với DTO ScApprovalRequest bên Backend
export interface ScApprovalRequest {
  hasStock: boolean; // Có hàng trong kho không?
  appointmentDate?: string; // Ngày hẹn (nếu hết hàng), định dạng YYYY-MM-DD
  note?: string; // Ghi chú
}

//Tương ứng với DTO ScProcessRequest bên Backend
export interface ScRejectRequest {
